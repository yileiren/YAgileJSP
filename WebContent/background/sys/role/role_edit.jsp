...
<body class="easyui-layout">
	...
	<form id="roleEditForm" method="post" action="<%=basePath%>/background/sys/role/roleSave.action">
		<input type="hidden" id="roleId" name="roleId" value="<s:if test="role == null">-1</s:if><s:else><s:property value="roleId" /></s:else>" />
		<table class="editTable" style="width:100%;">
            <tr><th style="width:120px">名称：</th><td><input type="input" id="roleName" name="role.name" value="<s:property value="role.name" />" class="easyui-validatebox" data-options="required:true" maxlength="20" style="width:300px" /></td></tr>
            <tr><th style="width:120px">说明：</th><td><input type="input" id="roleExplain" name="role.explain" value="<s:property value="role.explain" />" maxlength="50" style="width:300px" /></td></tr>
        </table>
    </form>
	</div>
