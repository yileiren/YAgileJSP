...
<body class="easyui-layout">
	...
	<form id="menuEditForm" method="post" action="<%=basePath%>/background/sys/menu/menuSave.action">
		...
		<table class="editTable" style="width:100%;">
            ...
            <tr><th style="width:120px">序号：</td><td><input type="text" id="menuOrder" name="menuOrder" class="easyui-numberbox" min="0" max="50000" precision="0" value="<s:property value="menuOrder" />" style="width:300px" /></td></tr>
        </table>
    </form>
	</div>
